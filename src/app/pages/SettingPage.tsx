...
import { ChatGPTMode, UserConfig, getUserConfig, updateUserConfig } from '~services/user-config'
        ...
        <div className="flex flex-col gap-5 w-fit max-w-[700px]">
          <ChatBotSettingPanel title="ChatGPT">
            <div className="flex flex-col gap-2">
              <p className="font-medium text-sm">{t('Mode')}</p>
              <div className="w-[250px]">
                <Select
                  options={Object.entries(ChatGPTMode).map(([k, v]) => ({ name: k, value: v }))}
